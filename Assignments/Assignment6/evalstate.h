 ...
 */
    ...
    * Usage: setCurrentLine(new_line_number);
    * --------------------------------------
    * Sets the current line number of the state
    */
   void setCurrentLine(int number);

   /*
    * Method: getCurrentLine
    * Usage: current_line_number = getCurrentLine();
    * --------------------------------------
    * Returns the current line number of state
    */
   int getCurrentLine();
